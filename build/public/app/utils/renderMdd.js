...
>`+i} `})).replace(/<Q>.+?<\/Q>/gms,function(e){let i=e.slice(3,-4).split("\n").filter(e=>!!e),t="",s=[],n=[],r=0,o=0,a=0,c="";i.forEach(e=>{let i=e.trim();i.startsWith("?")?t=i.slice(1):i.startsWith("!")?(i.endsWith("*")&&(r=s.length,i=i.slice(0,-1)),s.push(i.slice(1))):i.startsWith("+")?n.push(i.slice(1)):i.startsWith("p:")?o=Number(i.slice(2)):i.startsWith("c:")?a=Number(i.slice(2)):c+=e+"\n"});var l="Multiple Choice Question",d=(s.find(e=>"true"===e.toLowerCase())&&s.find(e=>"false"===e.toLowerCase())&&(l="True or False"),new MultipleChoice({answers:s,correct:r,descriptions:n,points:o,coins:a,elementNum:h},null));return h++,`<div class="multiple-choice-wrapper" onclick="document.querySelector('.stack-width').classList.add('blur-all-non-mc-questions')">
        ...
        </div>`})).replace(/<P>.+?<\/P>/gms,function(e){let i=e.slice(3,-4).split("\n").filter(e=>!!e),t="",n="",s=[],r="",o=0,a=0,c="";i.forEach(e=>{let i=e.trim();i.startsWith("?")?t=i.slice(1):i.startsWith("!")?n=i.slice(1):i.startsWith("^")?r=i.slice(1):i.startsWith("+")?s.push(i.slice(1)):i.startsWith("p:")?o=Number(i.slice(2)):i.startsWith("c:")?a=Number(i.slice(2)):c+=e+"\n"});var[l,d,p]=s,l=new ShortAnswer({placeholder:l,correctDescription:d,incorrectDescription:p,graderFunction:e=>{var i=n,t=e,s=i;return r&&(t=Function("response",r.includes("return ")?r:"return "+r)(e),s=Function("response",r.includes("return ")?r:"return "+r)(i)),"boolean"==typeof t?e:t.trim()===s.trim()},points:o,coins:a,elementNum:h},null);return h++,`<div class="multiple-choice-wrapper" onclick="document.querySelector('.stack-width').classList.add('blur-all-non-mc-questions')">
