const ModuleComponent=require("./ModuleComponent.js"),renderElement=require("../utils/renderElement.js");class Congratulations extends ModuleComponent{constructor(t,e){super(t,e)}render(t){return null!=this.data()?`<div class="information-wrapper">
