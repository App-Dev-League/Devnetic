...
function createModuleIndex() {
    ...
    Object.entries(actions).forEach(([key, value]) => {
        ...
        <div class="track-header-bg"></div><div class="track-header-card stack-width animate-out"><a class="backhome" href="#/"><span class="codicon codicon-arrow-left"></span>Back Home</a>
...
<div class="stack-width lesson-chooser">
	<h2 class="animate-out">Lessons</h2>
	${moduleData[value].weeks.map((data, index) => {
            return `
        <a class="module-button animate-out" href="#/learn/${value}/${index}/">
